    ...
    <CustomLayout layoutType={layoutType}>
      <form onSubmit={formik.handleSubmit}>
        <VerticalStackLayout gap={5}>
          ...
          <Flex alignItems="center" justifyContent="between" className="flex-col gap-2 sm:flex-row">
            <label htmlFor="formCheckbox" className="flex cursor-pointer items-center gap-2">
              <LoginFormCheckbox />
          ...
          <p className="self-center text-center text-sm font-medium sm:text-base">
